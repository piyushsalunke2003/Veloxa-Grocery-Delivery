...
export const getAdminStats = async (req: Request, res: Response) => {
    const [totalOrders, totalUsers, totalProducts, outOfStock, totalPadrtners, recentOrders] = await Promise.all([
    ...
    res.json({totalOrders, totalUsers, totalProducts, outOfStock, totalPadrtners, recentOrders})
}
